...
exports.run = (client, message, args) => {
    ...
    if (!args[0]) return message.channel.send("<:false:551460099600678944> **Syntaxe : `b!addnotepublic <Notes>`**")
...
message.delete();
message.channel.send("<:true:551460100347396107> **Vos notes public ont bien été actualisés avec succès.**")
}